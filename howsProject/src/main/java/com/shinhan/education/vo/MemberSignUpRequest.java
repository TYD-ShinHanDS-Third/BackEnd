...
public class MemberSignUpRequest {
	...
	public Members toEntity() {
	    ...
	    public MemberSignUpRequest(String memberid, String membername, String pswd, String checkedpswd, Date bday,
	                               String phone, Role roles, String accBank, String accno, Integer hasjob, Date hiredate,
	                               Integer marry, int haschild,MemberLevel memberLevel) {
    ...
    public boolean hasAdditionalInfo() {
        // accBank, accno, hasjob, hiredate, marry, haschild 중 모두 null이 아니면 추가 정보가 있다고 판단
        return accBank != null && accno != null && hasjob != null && hiredate != null && marry != null && haschild != 0;
    }
