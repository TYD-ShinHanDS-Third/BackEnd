...
public class Naver_Sens_Approved {
    @SuppressWarnings("unchecked")
    public void send_msg(String tel, String membername, String loanname) {
        // 호스트 URL
        ...
        // 개인 인증키
        String accessKey = "w57ZA7DSzASCtq5HFUgm";
        // 2차 인증을 위해 서비스마다 할당되는 service secret
        String secretKey = "poLu5VGxF1WVl1CD2Jaz3NmnoQPJuobV1o8lmf2K";
        // 프로젝트에 할당된 SMS 서비스 ID
        String serviceId = "ncp:sms:kr:309800430814:service";
        // 요청 method
        String method = "POST";
        ...
        bodyJson.put("from", "01077658333");
        bodyJson.put("messages", messagesArr);
    ...
    public static String makeSignature(String url, String timestamp, String method, String accessKey,
